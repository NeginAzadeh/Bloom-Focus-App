...
<template>
  <section class="mt-4 rounded-2xl bg-white px-4 py-5 text-center shadow-sm ring-1 ring-black/5" aria-label="Session timer">
    <div class="text-xs font-semibold uppercase tracking-wide text-black/45">End In</div>
    <div class="mt-1 font-mono text-4xl font-bold tracking-wider text-black">
      {{ hh }} : {{ mm }} : {{ ss }}
    </div>
  </section>
</template>
