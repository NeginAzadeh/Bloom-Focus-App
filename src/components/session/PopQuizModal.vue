  ...
  <teleport to="body">
    <div v-if="open" class="fixed inset-0 z-[12000]">
      ...
      <div class="absolute left-1/2 top-1/2 w-[92%] max-w-md -translate-x-1/2 -translate-y-1/2">
        <div class="rounded-3xl bg-white p-4 shadow-2xl ring-1 ring-black/10" @click.stop>
          <!-- PROMPT -->
          <div v-if="screen === 'prompt'" class="py-2">
            ...
            <div class="mt-6 flex gap-3">
              <button
                class="flex-1 rounded-2xl bg-black py-2 text-sm font-semibold text-white transition hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#57B884]"
                @click="onNo"
              >
                NO
              </button>
              ...
              <button
                class="flex-1 rounded-2xl bg-[#57B884] py-2 text-sm font-semibold text-white transition hover:bg-[#469D6F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#57B884] disabled:opacity-60 disabled:hover:bg-[#57B884]"
                @click="onLetsGo"
                :disabled="total === 0"
              >
                Let's go
          ...
          <div v-else-if="screen === 'quiz'">
            ...
            <div class="space-y-2">
              <button
                ...
                :key="opt.id"
                class="w-full rounded-2xl border border-black/10 px-3 py-3 text-left text-sm transition hover:bg-[#F7FAF8] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#57B884]"
                :class="selected === opt.id ? 'bg-[#57B884] text-white border-transparent hover:bg-[#469D6F]' : 'bg-white text-black/80'"
                @click="pick(opt.id)"
              >
                {{ opt.text }}
              </button>
            ...
            <div class="mt-4 flex gap-3">
              ...
              <button
                v-if="idx > 0"
                class="flex-1 rounded-2xl border border-black/10 py-2 text-sm font-semibold text-black/70 transition hover:bg-black/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#57B884]"
                @click="backOne"
              >
                Back
              </button>
              ...
              <button
                class="rounded-2xl bg-[#57B884] py-2 text-sm font-semibold text-white transition hover:bg-[#469D6F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#57B884] disabled:opacity-60 disabled:hover:bg-[#57B884]"
          ...
          <div v-else-if="screen === 'failSummary'" class="py-8 text-center">
            ...
            <div class="mt-8 flex gap-3">
              <button
                class="flex-1 rounded-2xl bg-[#57B884] py-2 text-sm font-semibold text-white transition hover:bg-[#469D6F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#57B884]"
                @click="analyze"
              >
                Analyze the mistake
              </button>
          ...
          <div v-else class="py-2">
            ...
            <div class="space-y-3 max-h-[55vh] overflow-auto pr-1">
              <div
                ...
                :key="w.qid"
                class="rounded-2xl bg-white p-3 shadow-sm ring-1 ring-black/5"
              >
                ...
                <div class="mt-1 rounded-xl bg-[#F7FAF8] px-3 py-2 text-sm text-black/80 ring-1 ring-black/5">
                  {{ w.correctText }}
                </div>
                ...
                <div class="mt-3 flex justify-end">
                  <button
                    class="rounded-xl bg-[#57B884] px-3 py-2 text-xs font-semibold text-white transition hover:bg-[#469D6F] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#57B884]"
                ...
                <div
                  ...
                  class="mt-3 rounded-2xl bg-[#F7FAF8] px-3 py-3 text-sm leading-relaxed text-black/70 ring-1 ring-black/5"
                >
                  {{ moreFor(w) }}
                </div>
              </div>
